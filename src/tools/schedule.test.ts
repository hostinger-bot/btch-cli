...
describe("schedule helpers", () => {
  ...
  it("creates, lists, and removes recurring schedules under ~/.btch/schedules", async () => {
    const home = makeTempDir("btch-schedule-home-");
    const cwd = makeTempDir("btch-schedule-cwd-");
